...
from pe_memberdna.assignment.lib.schemas.campaign_schemas import (
    ...
    def execute_assignment_scripts(
        ...
        for script in scripts_run:
            ...
            if script == "create_coupons.py":
                ...
                import pe_memberdna.assignment.scripts.create_coupons as create_coupons

                create_coupons.main(self.config_file_path)
            elif script == "assign_offers.py":
                # see comment for case create_coupons.py
                import pe_memberdna.assignment.scripts.assign_offers as assign_offers

                assign_offers.main(self.config_file_path)
            elif script == "subsample_population.py":
                # see comment for case create_coupons.py
                import pe_memberdna.assignment.scripts.subsample_population as subsample_population

                subsample_population.main(self.config_file_path)
            elif script == "backtest_sizing.py":
                # see comment for case create_coupons.py
                import pe_memberdna.assignment.scripts.backtest_sizing as backtest_sizing

                backtest_sizing.main(self.config_file_path)
            elif script == "qc_assignments.py":
                # see comment for case create_coupons.py
                import pe_memberdna.assignment.scripts.qc_assignments as qc_assignments

                qc_assignments.main(self.config_file_path)
            elif script == "generate_output_file.py":
                # see comment for case create_coupons.py
                import pe_memberdna.assignment.scripts.generate_output_file as generate_output_file

                generate_output_file.main(self.config_file_path)
            elif script == "generate_input_mail.py":
                import pe_memberdna.assignment.scripts.generate_input_mail as generate_input_mail

                generate_input_mail.main(self.config_file_path)
            elif script.startswith("assign_closure.py"):
                # see comment for case create_coupons.py
                import pe_memberdna.assignment.scripts.assign_closure as assign_closure
                ...
                # see comment for case create_coupons.py
                import pe_memberdna.assignment.scripts.generate_msmt_input as generate_msmt_input
