...
from memberdna.category_square.category_square.exclusions.exclusion_inheritance import *
from memberdna.category_square.category_square.square import Square
from memberdna.category_square.category_square.features import *
from memberdna.category_square.category_square.seasonality_features import *
from memberdna.category_square.category_square.post_processors import *
...
class Build:
    ...
    def execute(reqs, config):
        ...
        s.square = s.square.withColumn('PCT_GROSS_MARGIN', F.lit(0)) \
    ...
    def post_process(s):
        ...
        bounds = {'MONTH_1_SEASONALITY': standard,
        ...
        means = {'MONTH_1_SEASONALITY': standard_mean,
