...
from pe_member_dna.cube.utils.utility import (
    get_max_file_date,
    get_next_file_date,
)
from pe_member_dna.pipelines.cf_model.lib.cf_utils import get_latest_prop_path
...
for AH_type in ["AH4", "AH5"]:
    ...
    if args.prop_path == "automatic":
        prop_path = get_latest_prop_path(
            ...
            "MODELDATA/PREDICTIONS/TRIP_SPEND_MODELS/",
    ...
    config["paths"][
        "ETL_LOG"
    ] = "s3://memberanalytics-data-out-prod/MODELDATA/LOGS/cf_etl.csv"
    config["paths"][
        "TRAIN_LOG"
    ] = "s3://memberanalytics-data-out-prod/MODELDATA/LOGS/als_train.csv"
    config["paths"][
        "PREDICT_LOG"
    ] = "s3://memberanalytics-data-out-prod/MODELDATA/LOGS/cf_predict.csv"
    config["paths"][
        "COMBINE_LOG"
    ] = "s3://memberanalytics-data-out-prod/MODELDATA/LOGS/cf_combine_preds.csv"
    config["paths"][
        "TUNE_LOG"
    ] = "s3://memberanalytics-data-out-prod/MODELDATA/LOGS/als_tune.csv"
