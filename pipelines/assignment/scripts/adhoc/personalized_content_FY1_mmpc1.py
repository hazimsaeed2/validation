...
mail_subset = spark.read.option("header", "true").csv("s3://memberanalytics-data-out/ASSIGNMENTS/cdsa/assn_output/PROD/FY20MMPC1/lambda30_2018-12-19/mail_subset").cache()
