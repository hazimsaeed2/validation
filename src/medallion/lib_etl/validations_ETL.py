...
class TestOutlierDays(DQ_check):
    ...
    def test_body(self):
        ...
        self.df.createOrReplaceTempView("df_1")
        ...
        aggs_df.createOrReplaceTempView("df_2")

        
        _tmp_tbl("SELECT MAX(PURCH_DT) AS max_dt FROM df_2", "max_dt_tab")
        ...
        for col_id, col in enumerate(self.amnt_check_cols):
            ...
            d.createOrReplaceTempView("daily_aggregates")
